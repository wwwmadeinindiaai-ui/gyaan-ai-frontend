      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-blue-400">Gyaan AI</h3>
            <p className="text-gray-400 text-sm">
              Empowering learners with AI-driven education. Master new skills and knowledge with personalized learning experiences.
            </p>
          </div>
